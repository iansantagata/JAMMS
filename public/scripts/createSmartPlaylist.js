...
function addRuleFormFields()
{
    ...
    const energyRuleType = document.createElement("option");
    energyRuleType.setAttribute("value", "energy");
    energyRuleType.innerText = "Energy";
    ...
    const livenessRuleType = document.createElement("option");
    livenessRuleType.setAttribute("value", "liveness");
    livenessRuleType.innerText = "Liveness";
