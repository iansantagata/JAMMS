...
To start up the application after pulling the dependencies, simply run `npm start` in the root directory of the repository.  By default, this will allow you to make changes locally and see them updated by `node` as you save them.
